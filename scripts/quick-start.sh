...
# SoftwareHub - Quick Start
# Script para início rápido e preview do sistema

set -e

echo "🚀 SoftwareHub - Quick Start"
echo "📅 $(date)"
echo ""
...
show_status() {
    ...
    if command -v xdg-open &> /dev/null; then
        ...
        log_info "Abra manualmente: http://localhost:8087"
    fi
}

# Main function
main() {
    log_info "=== SoftwareHub - Quick Start ==="
...
# Error handling
trap 'log_error "Quick start falhou! Verifique os logs acima."; exit 1' ERR
